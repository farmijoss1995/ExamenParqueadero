...
a persistence unit "ExamenParqueaderoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenParqueadero\pom.xml":
...
artifact ("ExamenParqueadero.war") is already built. You can build
